<div class="contact_grid_container">
  <?php
    ...
    $pic =  $account->picture;
      ...
      <div class="card_back" style="display:none;">Stats for <?php print $account->fullname; ?> <img src="<?php echo $GLOBALS['base_path'].drupal_get_path('module', 'cz_custom'); ?>/theme/back.png" /></div>
    </div>
